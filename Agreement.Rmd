...
rownames(overall_agreement_matrix)[8:9] <- paste("Manual",8:9)
colnames(overall_agreement_matrix) <- c(1:9)
colnames(overall_agreement_matrix)[1:7] <- paste("IA", 1:7)
colnames(overall_agreement_matrix)[8:9] <- paste("Manual",8:9)
library(ggplot2)
library(reshape2)
...
ggplot(data = melted_overall_agreement, aes(x=Var1, y=Var2, fill=value)) +
  ...
  labs(title="Overall Agreement between IA Methods", x="IA Method", y="IA Method", fill="Overall Agreement") +
  theme_minimal()
ggplot(data = melted_overall_agreement, aes(x=Var1, y=Var2, fill=value)) +
